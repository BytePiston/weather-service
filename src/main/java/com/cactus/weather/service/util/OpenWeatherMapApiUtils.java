...
public final class OpenWeatherMapApiUtils {
  ...
  public static final String QUERY_BY_COORDINATES =
      "?lat="
          + QUERY_PLACEHOLDER_LATITUDE
          + "&lon="
          + QUERY_PLACEHOLDER_LONGITUDE
          + QUERY_PARAM_API_KEY
          + RESPONSE_MODE_JSON
  ...
  public static final String QUERY_BY_ZIP_COUNTRY =
      "?zip="
          + QUERY_PLACEHOLDER_ZIP_CODE
          + ","
          + QUERY_PLACEHOLDER_COUNTRY_CODE
          + QUERY_PARAM_API_KEY
          + RESPONSE_MODE_JSON
          + QUERY_PARAM_UNITS_METRIC;
