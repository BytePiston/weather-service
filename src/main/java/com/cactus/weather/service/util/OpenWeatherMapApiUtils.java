...
public final class OpenWeatherMapApiUtils {
  ...
  // Cache TTL in minutes; Can be moved to config-server when we scale the
  // application;
  ...
  public static final String QUERY_PARAM_UNITS_METRIC =
      QUERY_PARAM_UNITS + CONSTANT_UNIT_METRIC;

  public static final String QUERY_PARAM_UNITS_IMPERIAL =
      QUERY_PARAM_UNITS + CONSTANT_UNIT_IMPERIAL;

  public static final String QUERY_PARAM_UNITS_STANDARD =
      QUERY_PARAM_UNITS + CONSTANT_UNIT_STANDARD;
  ...
  private static final String QUERY_PARAM_API_KEY =
      "&appid=" + QUERY_PLACEHOLDER_API_KEY;

  // Query URL for the OpenWeatherMap API;
  public static final String QUERY_BY_COORDINATES =
      "?lat=" + QUERY_PLACEHOLDER_LATITUDE +
      "&lon=" + QUERY_PLACEHOLDER_LONGITUDE + QUERY_PARAM_API_KEY +
      RESPONSE_MODE_JSON + QUERY_PARAM_UNITS_METRIC;

  public static final String QUERY_BY_ZIP =
      "?zip=" + QUERY_PLACEHOLDER_ZIP_CODE + QUERY_PARAM_API_KEY +
      RESPONSE_MODE_JSON + QUERY_PARAM_UNITS_METRIC;

  public static final String QUERY_BY_ZIP_COUNTRY =
      "?zip=" + QUERY_PLACEHOLDER_ZIP_CODE + "," +
      QUERY_PLACEHOLDER_COUNTRY_CODE + QUERY_PARAM_API_KEY +
      RESPONSE_MODE_JSON + QUERY_PARAM_UNITS_METRIC;

  public static final String QUERY_BY_CITY_NAME =
      "?q=" + QUERY_PLACEHOLDER_CITY_NAME + QUERY_PARAM_API_KEY +
      RESPONSE_MODE_JSON + QUERY_PARAM_UNITS_METRIC;

  public static final String QUERY_BY_CITY_COUNTRY =
      "?q=" + QUERY_PLACEHOLDER_CITY_NAME + "," +
      QUERY_PLACEHOLDER_COUNTRY_CODE + QUERY_PARAM_API_KEY +
      RESPONSE_MODE_JSON + QUERY_PARAM_UNITS_METRIC;

  public static final String QUERY_BY_CITY_STATE_COUNTRY =
      "?q=" + QUERY_PLACEHOLDER_CITY_NAME + "," + QUERY_PLACEHOLDER_STATE_CODE +
      "," + QUERY_PLACEHOLDER_COUNTRY_CODE + QUERY_PARAM_API_KEY +
      RESPONSE_MODE_JSON + QUERY_PARAM_UNITS_METRIC;

  public static final String QUERY_BY_CITY_ID =
      "?id=" + QUERY_PLACEHOLDER_CITY_ID + QUERY_PARAM_API_KEY +
      RESPONSE_MODE_JSON + QUERY_PARAM_UNITS_METRIC;
}
