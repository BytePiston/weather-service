...
public class CityRequestModel {
  ...
  @Pattern(regexp = "^[a-zA-Z]{2}$",
           message = "State code must be a two-letter code")
  ...
  public boolean hasId() { return Objects.nonNull(id) && !id.isEmpty(); }

  public boolean hasName() { return Objects.nonNull(name) && !name.isEmpty(); }
}
