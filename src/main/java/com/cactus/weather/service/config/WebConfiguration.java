...
public class WebConfiguration {
   ...
   *key-value pair of TTL and WeatherResponse. TTL is calculated in milliseconds
   *based on the generated time of the weather data + 10 minutes as refresh data
   *time specified by OpenWeatherMapAPI Docs.
   **************************************************************************************/
  @Bean
  @Scope("singleton")
