...
public interface WeatherService {
  ...
  getCurrentWeatherByCityNameAndCountryCode(String cityName, String stateCode)
      throws ResourceNotFoundException;
  ...
  Optional<WeatherResponse> getCurrentWeatherByZipCode(String zip)
      throws ResourceNotFoundException;
  ...
  Optional<WeatherResponse> getCurrentWeatherByCoordinates(Double latitude,
                                                           Double longitude)
      throws ResourceNotFoundException;
}
