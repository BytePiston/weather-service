...
public class CurrentWeatherController {
   ...
   *scenarios; <p>
   *
   * If id is provided, the API will return the current weather of the city; GET
   *URL: api/v1/current/weather/city?id={id}; <p> Else, if city name is
   *provided, the API will return the current weather of the city based on below
   *scenarios; <p> 1) If state code and country code are not provided, the API
   *will return the current weather of the city; GET URL:
   *api/v1/current/weather/city?name={cityName}; <p> 2) If state code is
   *provided, the API will return the current weather of the city in the state;
   *GET URL: api/v1/current/weather/city?name={name}&stateCode={stateCode}; <p>
   * 3) If state code and country code are provided, the API will return the
   *current weather of the city in the state of the country; GET URL:
   ...
   * below scenarios;
   * <p>
   * 1) If country code is not provided, the API will return the current weather
   * based on zip code; GET URL: api/v1/current/weather/zip?zipCode={zipCode};
   * <p>
   * 2) If country code is provided, the API will return the current weather
   * based on zip code and country code; GET URL:
   ...
   * provided parameters as JSON request; <p> POST URL:
   ...
   * following scenarios;
   * <p>
   * 1) If state code and country code are not provided, the API will return the
   * current weather of the city; GET URL:
   * api/v1/current/weather/city?name={cityName}; <p> 2) If state code is
   * provided, the API will return the current weather of the city in the state;
   * GET URL: api/v1/current/weather/city?name={cityName}&stateCode={stateCode};
   * <p>
   * 3) If state code and country code are provided, the API will return the
   * current weather of the city in the state of the country; GET URL:
   * api/v1/current/weather/city?name={cityName}&stateCode={stateCode}&countryCode={countryCode};
